...
class Ui_MainWindow(object):
    ...
    def openQuiz(self,ques,options):
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_MainWindow1()
        self.ui.setupUi_1(self.window,ques,options)
        self.window.show()
        MainWindow.hide()
    ...
    def setupUi(self, MainWindow):
        ...
        # On click of connect
        ques = "What is the name of our Solar System ?"
        options = ["Milky Way","Andromeda","Sun","Pluto"]
        self.pushButton.clicked.connect(lambda: self.openQuiz(ques,options))
